<?php
    ...
    class Yop_Poll_Public_Admin extends Yop_Poll_Plugin {
        ...
        public function return_yop_poll( $id, $results, $tr_id = '',$show_results="", $offset = 0 ) {
            ...
            $yop_poll_model_error_list = array(
                'NoVoteRegistered'       => __( 'No vote was registered!' , 'yop_poll' ),
                'NoAnswerSelected'       => __( 'No answer selected!' , 'yop_poll' ),
                'BadRequest'             => __( 'Bad Request!' , 'yop_poll' )
            );
            ...
            wp_localize_script( 'yop-poll-public-js', 'yop_poll_model_error_list', $yop_poll_model_error_list );
